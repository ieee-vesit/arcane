...
if (totalFee === 0) {
  ...
  const styles = {
    page: {
      ...
      alignItems: "center",
      padding: isMobile ? "20px 8px" : "60px 16px",
    },
    card: {
      width: "100%",
      maxWidth: "900px",
    ...
    sectionTitle: {
      fontSize: "18px",
      margin: isMobile ? "20px 0 12px" : "28px 0 14px",
      fontWeight: "600",
    ...
    qrBox: { 
      flex: isMobile ? "1 0 100%" : "0 0 220px", 
  ...
  return (
    <div style={styles.page}>
      <form style={styles.card} onSubmit={handleSubmit}>
        ...
        <div style={{ height: isMobile ? "12px" : "16px" }} />
        ...
        {/* Member 3 */}
        <div style={styles.memberHeader}>
          <div style={styles.sectionTitle}>Team Member 3</div>
        ...
        {/* Member 4 */}
        <div style={styles.memberHeader}>
          <div style={styles.sectionTitle}>Team Member 4</div>
